...
rhog = RIHOG(num_spatial_bins=4, delta_radius=6, num_orientation_bins=9)

img = cv2.imread('data/test/test5.png', 0)
...
features, drawing = rhog.process_image('data/test/test5.png', True)
